...
#     return MagicMock(spec=EntityListener)
...
#     mock_entity_listener: MagicMock,
...
#         modification_name="test_modification",
#         device_id="device_1",
...
#     mock_device_tools._ensure_device = MagicMock(return_value=mock_device_entry)
#     await mock_device_tools._async_on_modification_added(mock_device_modification)
#     mock_device_tools._async_apply.assert_called_once_with(
#         mock_device_entry, mock_device_modification
#     )
...
#     mock_device_tools._async_revert.assert_called_once_with(
#         mock_device_entry, mock_device_modification
#     )
...
#     await mock_device_tools._async_apply(mock_device_entry, mock_device_modification)
...
#     await mock_device_tools._async_revert(mock_device_entry, mock_device_modification)
...
#     mock_device_tools._async_apply.assert_called_once_with(
#         mock_device_entry, mock_modification
#     )
...
#     mock_device_tools._async_apply.assert_not_called()
#     mock_device_tools._device_tools_history_data.update_attribute_history.assert_not_called()
...
# def test_ensure_device_exists(
#     mock_device_tools: DeviceTools, mock_device_entry: MagicMock
# ):
#     mock_device_tools._device_registry.async_get = MagicMock(
#         return_value=mock_device_entry
#     )
#     device_modification = {"device_id": "device_1"}
#     device = mock_device_tools._ensure_device(device_modification)
#     assert device == mock_device_entry
#     mock_device_tools._device_registry.async_get.assert_called_once_with("device_1")


# def test_ensure_device_not_exists(mock_device_tools: DeviceTools):
#     mock_device_tools._device_registry.async_get = MagicMock(return_value=None)
#     device_modification = {"device_id": "device_1"}
#     with pytest.raises(ValueError, match="Device not found \(id: device_1\)"):
#         mock_device_tools._ensure_device(device_modification)
#     mock_device_tools._device_registry.async_get.assert_called_once_with("device_1")
